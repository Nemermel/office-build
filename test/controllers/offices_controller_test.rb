...
class OfficesControllerTest < ActionController::TestCase
  ...
  test "should create office" do
    assert_difference('Office.count') do
      post :create, office: { cost: @office.cost, description: @office.description, image: @office.image, name: @office.name }
    end
  ...
  test "should update office" do
    patch :update, id: @office, office: { cost: @office.cost, description: @office.description, image: @office.image, name: @office.name }
    assert_redirected_to office_path(assigns(:office))
  end
